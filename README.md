...
서로 다른 장르·프레임워크의 게임 3개([dungeon100](https://github.com/Hakhyun-Kim/dungeon100) 3D 로그라이크,
[defenehero](https://github.com/Hakhyun-Kim/defenehero) 3D 타워 디펜스, [door-runner](https://github.com/Hakhyun-Kim/door-runner) 2D 러너)에서
...
| 아키텍처 4대 규약 | 순수 로직/렌더 분리 · 시드 결정론 · 밸런스 단일 파일 · 이벤트 방출 |
| **AI 자동 밸런싱** ★ | 가상 플레이어(초보/보통/고수) 봇 시뮬레이션 → 사망 분포 → 기준선 회귀 게이트 |
...
| 자동 검증 하네스 | 디버그 훅 · ?rafshim · 고정 타임스텝 · 픽셀 회수 — AI가 자기 게임을 플레이 |
| 부트스트랩 체크리스트 | 새 게임 시작 시 복사해 쓰는 16항목 |
